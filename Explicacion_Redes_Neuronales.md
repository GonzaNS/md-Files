...
ENTRADA (5 datos)
      │
  ┌───▼───┐
  │  64   │  ← Capa 1: 64 neuronas (aprenden rasgos generales)
  └───┬───┘
      │
  ┌───▼───┐
  │  32   │  ← Capa 2: 32 neuronas (refinan los patrones)
  └───┬───┘
      │
  ┌───▼───┐
...
|---|---|---|
| `epochs=300` | 300 vueltas | El modelo verá todos los datos de entrenamiento 300 veces |
...
Normalización con StandardScaler
        ...
        ▼
Definir arquitectura (capas Dense, activaciones)
        │
        ▼
Compilar (loss, optimizer, metrics)
        │
        ▼
Entrenar: model.fit() — 300/400 épocas
